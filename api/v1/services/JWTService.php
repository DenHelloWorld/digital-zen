...
class JWTService {
    ...
    public function validateToken($token) {
        ...
        // Check expiration: token is valid if current time is strictly before exp timestamp
        // This matches JWT standard and frontend validation (token-storage.service.ts)
