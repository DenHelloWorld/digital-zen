...
**Для существующих баз:** Если база уже была установлена до этого обновления, нужно выполнить миграцию для исправления схемы таблицы `focused_times`:

1. В phpMyAdmin выбери свою базу
2. Вкладка **SQL**
3. Скопируй весь текст из файла `api/migrate-focused-times.sql`
4. Вставь и нажми **Go**
