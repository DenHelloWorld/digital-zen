...
export class ThemeService {
  ...
  public toggle(): void {
    const newTheme: ColorSchemaType = this.#theme() === COLOR_SCHEMA_ENUM.LIGHT ? COLOR_SCHEMA_ENUM.DARK : COLOR_SCHEMA_ENUM.LIGHT;
    this.#theme.set(newTheme);
    this.#chromeStorageService.set(CHROME_STORAGE_KEY_ENUM.THEME, newTheme);
  }

  #loadTheme(): void {
    this.#chromeStorageService.get(CHROME_STORAGE_KEY_ENUM.THEME, (savedTheme: ColorSchemaType | null) => {
      if (savedTheme) {
