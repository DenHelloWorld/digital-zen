...
export enum DAY_OF_WEEK_SWORT_NAME_ENUM {
  SUNDAY = 'sun',
  MONDAY = 'mon',
  TUESDAY = 'tue',
  WEDNESDAY = 'wed',
...
export type DayOfWeekShortNameType =
  DAY_OF_WEEK_SWORT_NAME_ENUM.SUNDAY |
  DAY_OF_WEEK_SWORT_NAME_ENUM.MONDAY |
  DAY_OF_WEEK_SWORT_NAME_ENUM.TUESDAY |
  DAY_OF_WEEK_SWORT_NAME_ENUM.WEDNESDAY |
  DAY_OF_WEEK_SWORT_NAME_ENUM.THURSDAY |
  DAY_OF_WEEK_SWORT_NAME_ENUM.FRIDAY |
  DAY_OF_WEEK_SWORT_NAME_ENUM.SATURDAY;
