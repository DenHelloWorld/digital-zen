...
export enum DAY_OF_WEEK_NAME_ENUM {
  SUNDAY = 'sunday',
  MONDAY = 'monday',
  TUESDAY = 'tuesday',
  WEDNESDAY = 'wednesday',
...
export type DayOfWeekNameType =
  DAY_OF_WEEK_NAME_ENUM.SUNDAY |
  DAY_OF_WEEK_NAME_ENUM.MONDAY |
  DAY_OF_WEEK_NAME_ENUM.TUESDAY |
  DAY_OF_WEEK_NAME_ENUM.WEDNESDAY |
  DAY_OF_WEEK_NAME_ENUM.THURSDAY |
  DAY_OF_WEEK_NAME_ENUM.FRIDAY |
  DAY_OF_WEEK_NAME_ENUM.SATURDAY;
