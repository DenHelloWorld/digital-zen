    ...
    describe('Valid inputs', () => {
      ...
      it('should update an existing period', async () => {
        ...
        const updatedPeriod: IFocus.Period = {
          ...
          startFrom: new Date('2024-01-01T10:00:00.000Z'),
          endTo: new Date('2024-01-01T18:00:00.000Z'),
          isFocused: true,
          focusedTimes: [],
          daysOfWeek: [1, 2, 3],
          sessionStartTime: new Date('2024-01-01T10:00:00.000Z'),
          webSites: [],
        };
          ...
          focusedTimes: [
            {
              ...
              startFrom: new Date('2024-01-01T09:00:00.000Z'),
              endTo: new Date('2024-01-01T10:00:00.000Z'),
            },
            {
              id: 'ft-2',
              periodId: 'test-period-1',
              startFrom: new Date('2024-01-01T14:00:00.000Z'),
              endTo: new Date('2024-01-01T15:00:00.000Z'),
            },
          ],
          daysOfWeek: [1, 2, 3, 4, 5],
          sessionStartTime: null,
